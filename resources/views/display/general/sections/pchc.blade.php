            ...
            <table class="table table-striped table-sm m-0" style="width: 100%; table-layout: fixed; font-size: 1.2rem; border: 1px solid #a0a0a0; border-collapse: collapse;">
                <tbody style="font-size: 1.7rem; color:#000000; font-weight: 400;">
                    <tr>
                        ...
                        <td class="text-truncate" style="padding: 3px; border: 1px solid #a0a0a0;">{{ $rolespchc['consultant'] }}</td>
                        <td style="padding: 3px; width: 16%; border: 1px solid #a0a0a0;"><b>Cardiologist</b></td>
                        <td class="text-truncate" style="padding: 3px; border: 1px solid #a0a0a0; ">{{ $rolespchc['cardiologist'] }}</td>
                    </tr>
                    <tr>
                        <td style="padding: 3px; width: 15%; border: 1px solid #a0a0a0;"><b>1st Call</b></td>
                        <td class="text-truncate" style="padding: 3px; border: 1px solid #a0a0a0;">{{ $rolespchc['firstcall'] }}</td>
                        <td style="padding: 3px; width: 15%; border: 1px solid #a0a0a0;"><b>2nd Call</b></td>
                        <td class="text-truncate" style="padding: 3px; border: 1px solid #a0a0a0;">{{ $rolespchc['secondcall'] }}</td>
                    </tr>
                    <tr>
                        <td style="padding: 3px; width: 15%; border: 1px solid #a0a0a0;"><b>MO Call</b></td>
                        <td class="text-truncate" style="padding: 3px; border: 1px solid #a0a0a0;">{{ $rolespchc['mo'] }}</td>
                        <td style="padding: 3px; width: 15%; border: 1px solid #a0a0a0;"></td>
                        <td class="text-truncate" style="padding: 3px; border: 1px solid #a0a0a0;"></td>
                    </tr>
                </tbody>
            </table>
        </div>
