            ...
            <table class="table table-striped table-sm m-0" style="width: 100%; table-layout: fixed; font-size: 1.2rem; border: 1px solid #ffffff; border-collapse: collapse;">
                <tbody style="font-size: 1.8rem; color:#000000; font-weight: 600;">
                    <tr>
                        ...
                        <td class="text-truncate" style="padding: 3px; border: 1px solid #ffffff;">{{ $rolesct['consultant'] }}</td>
                        <td style="padding: 3px; width: 10%; border: 1px solid #ffffff;"><b>1st Call</b></td>
                        <td class="text-truncate" style="padding: 3px; border: 1px solid #ffffff; ">{{ $rolesct['firstcall'] }}</td>
                    </tr>
                    <tr>
                        <td style="padding: 3px; width: 10%; border: 1px solid #ffffff;"><b>2nd Call</b></td>
                        <td class="text-truncate" style="padding: 3px; border: 1px solid #ffffff;">{{ $rolesct['secondcall'] }}</td>
                        <td style="padding: 3px; width: 10%; border: 1px solid #ffffff;"><b>3rd Call</b></td>
                        <td class="text-truncate" style="padding: 3px; border: 1px solid #ffffff;">{{ $rolesct['thirdcall'] }}</td>
                    </tr>
                    <tr>
                        <td style="padding: 3px; width: 10%; border: 1px solid #ffffff;"><b>ICU AM</b></td>
                        <td class="text-truncate" style="padding: 3px; border: 1px solid #ffffff;">{{ $rolesct['icuam'] }}</td>
                        <td style="padding: 3px; width: 10%; border: 1px solid #ffffff;"><b>ICU PM</b></td>
                        <td class="text-truncate" style="padding: 3px; border: 1px solid #ffffff; ">{{ $rolesct['icupm'] }}</td>
                    </tr>
                </tbody>
            </table>
        </div>
